...
D = load('A10','r1','r2','r3','r4','r5','r6','r7','r8','r9','r10');   %10层随机相位掩膜板
...
for ii=1:K
    ...
    %吸收阶段
    for t1=1:1941
            p1{:,t1} = cat(2,p1{:,t1},zeros(1,288));
            MM{:,t1} = cat(2,MM{:,t1},zeros(1,288));
            p = xor(p1{:,t1}, p4);
            M = xor(MM{:,t1}, p5);
            matrix_p = matrix10(p);
            matrix_M = matrix10(M);
    ...
    %经过多重散射介质
            ...
            u = linspace(-1./2./L,1./2./L,10).*10;
            v = linspace(-1./2./L,1./2./L,10).*10;
            [u,v] = meshgrid(u,v);
