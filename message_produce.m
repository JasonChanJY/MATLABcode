...
function [p1,MM] = message_produce()
    ...
    len_add = mod(length(q7_copy), 512);
    data_supplyment_num = 512 - len_add;
...
%     end
    ...
    leng2 = length(j7)/512;
    p1 = mat2cell(j7,1,512*ones(1,leng2));
    MM = mat2cell(j8,1,512*ones(1,leng2));  %每个元组包含256位二进制数据，用p1{：，1}形式进行索引
